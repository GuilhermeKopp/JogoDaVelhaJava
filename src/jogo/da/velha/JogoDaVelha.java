...
public class JogoDaVelha extends JFrame {
	...
	JLabel xX = new JLabel("X 0");
	JLabel xO = new JLabel("O 0");
	...
	public JogoDaVelha() {
		...
		add(novo);
		add(zerar);
		placar.setBounds(560, 70, 100, 30);
		xX.setBounds(540, 95, 100, 30);
		xO.setBounds(590, 95, 100, 30);
		novo.setBounds(510, 140, 140, 30);
		zerar.setBounds(510, 195, 140, 30);
		...
		for (int i = 0; i < 3; i++) {
			for (int j = 0; j < 3; j++) {
				bt[cont] = new JButton();
				add(bt[cont]);
				bt[cont].setBounds((100 * i) + 170, (100 * j) + 80, 95, 95);
